...
import 'package:rong_tuli/widgets/Shared/featured_button.dart';
import 'package:rong_tuli/widgets/Shared/s_button.dart';
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children:
                    List.generate(2, (index) => sButtons(
                  ...
                  Row(
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: List.generate(3, (index) => sButtons(
                        height: context.screenHeight * 0.15,
                        width: context.screenWidth / 3.5,
                        icon: index == 0 ? icTopCategories : index == 1 ? icBrands : icTopSeller,
                        title: index == 0 ? topCategories  : index == 1 ? brand : topBrand,
                      ))
                  ),
                  20.heightBox,
                  Align(
